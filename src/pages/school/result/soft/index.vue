			  ...
			  <csearch v-bind:summary='summary' v-bind:nameSearch='nameSearch' v-on:toggleName='toggleName' v-bind:search='search' v-on:search='searcher'>
				...
				<el-table v-bind:data="softs" stripe class='w-100' size='small' @selection-change="handlePapers" >
				  ...
				  <el-table-column prop='uploader' label="上传者" width='60px'></el-table-column>
					<el-table-column prop='title' label='著作权名称' width='200px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='certno' label='证书号' width='140px' show-overflow-tooltip></el-table-column>
					...
					<el-table-column sortable v-bind:sort-method='gotsort' prop='got_at' label='获得时间' width='100px'></el-table-column>
					<el-table-column prop='type' label='著作权类型' width='100px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='owner' label='著作权人' width='100px' show-overflow-tooltip></el-table-column>
					<el-table-column sortable prop='rank' label="本人排名" width='94px'></el-table-column>
					<el-table-column sortable v-bind:sort-method='finishsort' prop='finish_at' label='开发完成时间' width='120px'></el-table-column>
					<el-table-column prop='regisno' label='登记号' width='100px' show-overflow-tooltip></el-table-column>
