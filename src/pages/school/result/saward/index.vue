			  ...
			  <csearch v-bind:summary='summary' v-bind:nameSearch='nameSearch' v-on:toggleName='toggleName' v-bind:search='search' v-on:search='searcher'>
				...
				<el-table v-bind:data="patents" stripe class='w-100' size='small' @selection-change="handlePapers" >
				  ...
				  <el-table-column prop='uploader' label="上传者" width='60px'></el-table-column>
					<el-table-column prop='title' label='比赛名称' width='200px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='rank' label='获奖名次' width='80px' show-overflow-tooltip></el-table-column>
					...
					<el-table-column prop='level' label='级别' width='100px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='unit' label='授予单位' width='110px'></el-table-column>
					<el-table-column sortable v-bind:sort-method='awardsort' prop='award_at' label='获奖时间' width='110px'></el-table-column>
					<el-table-column sortable prop='rank' label="本人排名" width='94px'></el-table-column>
					<el-table-column prop='student' label="获奖学生" width='94px'></el-table-column>
