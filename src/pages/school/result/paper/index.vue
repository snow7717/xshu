			  ...
			  <csearch v-bind:summary='summary' v-bind:nameSearch='nameSearch' v-on:toggleName='toggleName' v-bind:search='search' v-on:search='searcher'>
				  <div slot='fields' class='f-ib'>
					  <ctimesearch v-bind:search='search' v-if='!nameSearch'></ctimesearch>
						...
						<i class='bar-item f-fsn f-csp' ref='langTriggle'>
							<font>语言：</font>
						...
						<cfilter v-bind:labelW='labelW' v-bind:search='search' v-bind:filters='filters' v-on:handleAll='handleAll' v-on:handleChange='handleChange'></cfilter>
					</div>
					...
					<el-table-column fixed="right" label='操作' width='100px'>
					  <template slot-scope='scope'>
						  <i class='download f-csp el-icon-download' title='下载'></i>
							<i class='return iconfont icon-return f-csp' title='退回'></i>
							<i class='delete f-csp el-icon-delete' title='删除'></i>
						</template>
					</el-table-column>
				</el-table>
			</el-main>
