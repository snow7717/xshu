			  ...
			  <csearch v-bind:summary='summary' v-bind:nameSearch='nameSearch' v-on:toggleName='toggleName' v-bind:search='search' v-on:search='searcher'>
				...
				<el-table v-bind:data="patents" stripe class='w-100' size='small' @selection-change="handlePapers" >
				  ...
				  <el-table-column prop='uploader' label="上传者" width='60px'></el-table-column>
					<el-table-column prop='title' label='著作名称' width='200px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='rank' sortable label='本人排名' width='94px' show-overflow-tooltip></el-table-column>
					...
					<el-table-column prop='identity' label='身份' width='80px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='house' label='出版社' width='120px' show-overflow-tooltip></el-table-column>
					<el-table-column prop='type' label='著作类型' width='100px' show-overflow-tooltip></el-table-column>
					<el-table-column sortable v-bind:sort-method='pubsort' prop='pub_at' label='出版时间' width='110px'></el-table-column>
					<el-table-column prop='pubno' label='出版号' width='80px'></el-table-column>
					<el-table-column prop='pubaddress' label='出版地' width='110px'></el-table-column>
					<el-table-column prop='codes' label='字数' width='60px'></el-table-column>
