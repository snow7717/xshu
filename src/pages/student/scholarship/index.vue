		  ...
		  <caside active='4-7'></caside>
			<el-main class='result-main'>
			  <csearch v-bind:summary='`${summary}(${total})`' v-bind:nameSearch='nameSearch' v-on:toggleName='toggleName' v-bind:search='search' v-on:search='index(1)' placeholder='请输入名称'>
				...
				<el-table v-bind:data="scholarship" stripe class='w-100' size='small' @selection-change="handlePapers" >
				  <el-table-column type="selection" fixed width="40"></el-table-column>
					...
					<el-table-column prop='type' label="奖学金类型" show-overflow-tooltip></el-table-column>
					<el-table-column prop='quota' label="奖励额度" show-overflow-tooltip></el-table-column>
